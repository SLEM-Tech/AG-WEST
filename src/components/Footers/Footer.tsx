...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#EEEEEE] mx-2 md:mx-4 mb-10 py-2 flex flex-col item-center">
              ...
              <div key={index} className="flex flex-col gap-4 lg:gap-5 w-full">
                ...
                {section.links.map((link, linkIndex) => (
                  <Link
                    ...
                    className="text-black text-sm font-[400] leading-[1.3] hover:text-primary transition-[.3]"
                  >
                    {link.label}
                  </Link>
                ))}
        ...
        <section className="flex flex-col justify-between gap-1 sm:gap-6 mt-2 px-2 xs:px-6 sm:px-10">
          <div className="flex w-full justify-between items-end gap-4">
            <div className="">
              ...
              {/* <span className="text-black text-xs sm:text-base leading-[1.6] font-[400]">
                ..The best store for you!
              </span> */}
            </div>
          ...
          <div className="flex lg:gap-8 w-full pt-3 max-md:flex-col max-md:justify-center">
            {footerData.map((section, index) => (
