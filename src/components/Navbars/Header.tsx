    ...
    <>
      ...
      >
        ...
        <div className="hidden slg:grid grid-cols-4 items-center w-full py-1 max-w-[1200px] z-30 px-5 xl:px-0">
          ...
          <div className="relative flex justify-center h-10 col-span-2">
            <input
              type="text"
              placeholder="Search"
              className="text-base text-black/70 px-4 xl:w-[400px] rounded-l-sm outline-none  transition block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-gray-100 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              value={searchValue}
            ...
            {isSearchLoading ? (
              ...
              >
                <Search className="relative h-5 w-5 text-gray-400 inset-y-0 left-0"/>
              </button>
            )}
          </div>
              ...
              <div className="flex flex-col text-primary font-semibold text-sm">
                {firstName ? (
                  ...
                  <div className="flex flex-col">
                    <span
                      className="cursor-pointer hover:text-primary text-black transition"
            ...
            <div className="flex items-center gap-2">
              <Dropdown>
                <DropdownTrigger className="">
                  <button
                    type="button"
                    className="border hover:border-black hover:bg-white hover:text-black cursor-pointer transition-[.4] group group-hover:text-white p-0 size-10 lex items-center space-x-1 bg-black text-white px-3 py-1 rounded text-sm"
                  >
                    {baseCurrency?.symbol}
                  </button>
                </DropdownTrigger>
        ...
        {/* Mobile */}
        <div className="flex flex-col items-center w-full slg:hidden px-2 xs:px-4 mt-2">
